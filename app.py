...
from handlers.groups.setup_nag import setup_nag_loop
...
async def on_startup(dispatcher):
    ...
    # take the bot down — inspections and reminders don't depend on it.
    try:
        await start_webapp()
    except Exception:
    ...
    try:
        ...
        logging.exception("could not seed the super-admins")
